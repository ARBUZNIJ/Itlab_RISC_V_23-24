...
public:
	...
	T scal(size_t k, size_t ind)  //функци€ скал€рного произведени€ дл€ k столбцa матрицы A и вектора v, первый ненулевой элемент в котором располагаетс€ в позиции ind
	{
		T res = 0;
		//#pragma omp simd
